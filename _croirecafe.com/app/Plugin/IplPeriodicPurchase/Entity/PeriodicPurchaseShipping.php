...
if (!class_exists('\Plugin\IplPeriodicPurchase\Entity\PeriodicPurchaseShipping')) {
    /**
     * PeriodicPurchaseShipping
     *
     * @ORM\Table(name="plg_ipl_periodic_purchase_dtb_periodic_purchase_shipping")
     * @ORM\InheritanceType("SINGLE_TABLE")
     * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
     * @ORM\HasLifecycleCallbacks()
     * @ORM\Entity(repositoryClass="Plugin\IplPeriodicPurchase\Repository\PeriodicPurchaseShippingRepository")
     */
    class PeriodicPurchaseShipping extends \Eccube\Entity\AbstractEntity
    {
         ...
         *
         * @ORM\OneToOne(targetEntity="Plugin\IplPeriodicPurchase\Entity\PeriodicPurchase", inversedBy="PeriodicPurchaseShipping", cascade={"persist"})
         * @ORM\JoinColumns({
         ...
         *
         * @ORM\OneToMany(targetEntity="Plugin\IplPeriodicPurchase\Entity\PeriodicPurchaseItem", mappedBy="PeriodicPurchaseShipping", cascade={"persist"})
         */
        ...
        {
            return (new ItemCollection($this->PeriodicPurchaseItems))->sort();
        }
         ...
         * @return $this
         */
        public function setPeriodicPurchase(PeriodicPurchase $PeriodicPurchase)
        {
