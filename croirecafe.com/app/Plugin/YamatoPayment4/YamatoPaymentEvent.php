...
class YamatoPaymentEvent implements EventSubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            '@YamatoPayment4/mypage/credit.twig' => [['onMypageNaviTwig'], ['onMypageCreditChange']],
    ...
    public function onMypageCreditChange(TemplateEvent $event)
    {
        $moduleSettings = "";
        $creditCardList = "";
        ...
        if($Customer) {
            ...
            if($Order) {
                ...
                if($moduleSettings['use_option'] == '0') {
                    $result = $client->doGetCard($Customer->getId());
                    if($result) {
                        $creditCardList = $client::getArrCardInfo($client->results);
                    }
                }
